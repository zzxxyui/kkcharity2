...
array('Media Interview Info'  , "----", 			array("LG-START",""),array("HIDDEN", "0", false, false),array("SHOW", false, false, array()) 	 ),									 
...
array('News Content'  , "----", 			array("LG-START",""),array("HIDDEN", "0", false, false),array("SHOW", false, false, array()) 	 ),
...
$mycofig=array(
	...
	'tag'=>'project_mi',
	'keyfield'=>'id',
	'pageName'=>'Media Interview',
	'tableName'=>'project_mi', 
	'tableName_cat'=>'project', 
	
	
	'menuList'=>array( 
	 	'create'=>array('lv'=>1, 		'type'=>'',	'tag'=>'project_mi&action=create', 'title'=>'Create'	,'core'=>'./core/create.php'),
			'edit'=>array('lv'=>1, 		'type'=>'',	'tag'=>'project_mi&action=edit', 'title'=>'Edit '	,'core'=>'./core/edit.php'),
		 
			'list'=>array('lv'=>1, 		
			'type'=>'link',	'tag'=>'project_mi&action=list', 'title'=>'Media Interview'	,'core'=>'./core/list.php',
			'width'=>'100%'
			,'sublink'=> array(
					array('lv'=>1,'href'=>'project_mi&action=sort', 'title'=>$this->txt['sort']	,'width'=>'17%' 		, 'icon'=>'fa-bars' ),
					array('lv'=>1,'href'=>'project_mi&action=create', 'title'=>$this->txt['create']	,'width'=>'17%'		, 'icon'=>'fa-plus' ),
				)
			
			),
		 
 
			'sort'=>array('lv'=>1, 		'type'=>'',	'tag'=>'project_mi&action=sort', 'title'=>'Sort','core'=>'./core/sort.php',
			'sort_setting'=>array(
					'cat'=>true,
					'sort_type'=>'asc',
				//	 'cat_array'=>$carSelect,
...
'other_function'=>array(
  array('type'=>'onefile','key'=>'project_mi_onefile'),
	// array('type'=>'onefile','key'=>'project_mi_img2_onefile'),
)
 ...
 /*
	'sqlplus_selectadd'=>'	t1.	',
	'sqlplus_select'=>' ',
	'sqlplus_table'=>'	as t1 left join '.DB_START.'project_mi_cat as t2 on( t1.node_id=t2.id) ',
	'sqlplus_where'=>'	',
