...
include __DIR__.'/../../../app/config/laravelManager.php';
$manager = new laravelSessionManager($app);
...
function CheckAuthentication()
{
	...
	/*
if($_SESSION["logindetails"]['id']>0){
	//if($_SESSION['alreadyLogin_admin']=='1'){
		return true;
	}else{
		return false;
	}
 ...
 return (  Session::get('ckFinder_Authentication') 	) ? true: false;
...
*/
$path='/';
$baseUrl =Session::get('ckFinder_path') 	;
