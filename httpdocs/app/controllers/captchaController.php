...
class captchaController extends Controller {
	 ...
	 * @var string
	 */
	var $background_directory = "./app/controllers/captcha/backgrounds"; //'./backgrounds';
...
public	function captchaImg()
 ...
 $this-> captchaImg_proess();
		
$this->image_width = 85;
$this->image_height = 29;
//$img->perturbation = 0.9; // 1.0 = high distortion, higher numbers = more distortion
//$img->image_bg_color = new Securimage_Color("#ff0000");
$this->text_color = new Securimage_Color("#222222");
$this->text_transparency_percentage = 65; // 100 = completely transparent

		 $this->show();
	 $this->output();
	}
public	function captchaImg_proess()
	{
...
*/ 
	...
	//	$this->charset       = '1234567890';
		...
		$this->gd_font_file  = './app/controllers/captcha/gdfonts/automatic.gdf';
		$this->use_gd_font   = false;
		$this->gd_font_size  = 1;
		$this->text_x_start  = 15;

		$this->ttf_file      = './app/controllers/captcha/AHGBold.ttf';

		$this->perturbation       = 0.1;
		$this->iscale             = 1;
    ...
    $this->text_color       = new Securimage_Color(0x3d, 0x3d, 0x3d);
		...
		$this->text_transparency_percentage = 20;
		...
		$this->signature_font  = './app/controllers/captcha/AHGBold.ttf';
		...
		Session::put('securimage_code_value','asd'); 
	}
...
public	function saveData()
	{
		...
		*/
		...
		Session::put('securimage_code_value',  strtolower($this->code)); 
		Session::put('securimage_code_ctime', time());
	...
	function validate()
	{
	 ...
	 // echo  Session::get('securimage_code_value');
			
		if (  trim( Session::get('securimage_code_value')	) != '') {
	...
	function getCode()
	{
		...
		if (isset($_SESSION['securimage_code_value']) && !empty($_SESSION['securimage_code_value'])) {
			...
			*/
		if (    Session::get('securimage_code_value')!='' ) {
