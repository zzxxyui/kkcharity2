...
echo '				<div class="container ma0 row" style="padding:40px 0 0 0; margin:0 auto;">
		...
		<img src="'.url('static/images/logo.jpg').'" style="float:none;margin:0 auto;" alt="" class="img-responsive ma0" />
		</div>
		<div class="col-lg-8 col-lg-offset-2 text-center mt20  ">
		<h2 class="  m0 text-dred no-tf"   style="font-size:2.5em;" >';?>{{ $title }} <?php echo '</h2>
